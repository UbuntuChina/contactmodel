...
UBUNTU_TRANSLATION_DOMAIN="contactmodel.liu-xiao-guo"
...
aptest.commands = bash $$PWD/contactmodel/tests/autopilot/run
aptest.depends  = sub-contactmodel

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/contactmodel/tests/unit 
unittest.depends  = sub-contactmodel
